...
API_KEY = getenv("API_KEY", 'NxGBNexGenBots77980e') # youtube song api key, generate free key or buy paid plan from https://console.nexgenbots.xyz

UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/hbbb02219-hue/AviaxMusic",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/ganaasupport")
